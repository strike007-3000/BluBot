...
## Corpus Check
- 40 files · ~27,334 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 449 nodes · 790 edges · 52 communities (34 shown, 18 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 61 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `826ce099`
...
7. `send_draft_for_approval()` - 18 edges
...
Cohesion: 0.06
Nodes (82): article_matches_topic(), broadcast_stage(), curation_stage(), interaction_stage(), main(), persistence_stage(), Any, AsyncClient (+74 more)
...
Cohesion: 0.06
Nodes (49): main(), test_full_dry_run(), test_scoring(), fetch_feed_headlines(), main(), Fetches first 5 headlines from a single RSS feed., get_version(), Legacy wrapper for the new Settings validation logic. (+41 more)
