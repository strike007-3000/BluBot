...
BluBot v3.21.2 maintains a professional **Automated Test Suite** powered by `pytest`, including regression coverage for exact Gemini discovery, Gist recovery state, permanent provider errors, and Threads failures.
